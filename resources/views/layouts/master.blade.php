        ...
        <aside class="shadow app-sidebar bg-body-secondary" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="dist/index.html" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">Ngantin</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul
                        ...
                        @role('superAdmin')
                        <li class="nav-item">
                            <a href="{{ route('dashboard-all.index') }}"
                                class="nav-link {{ request()->routeIs('dashboard-all.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('kantin.index') }}"
                                class="nav-link {{ request()->routeIs('kantin.*') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-shop"></i>
                                <p>Manajemen Kantin</p>
                            </a>
                        </li>
                        @endrole
                        @role('admin')
